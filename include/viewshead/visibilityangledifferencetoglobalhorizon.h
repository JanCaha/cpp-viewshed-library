...
namespace viewshed
{
    class VisibilityAngleDifferenceToGlobalHorizon : public AbstractViewshedAlgorithm
    {

      public:
        VisibilityAngleDifferenceToGlobalHorizon( bool all = false, double invisibleValue = -181,
